...
def vis():
    ...
    if(less_count/(less_count+more_count+middle_count) > 0.5):
        val = input("We've noticed you've been listening to quite a few sad songs lately.\nWould you like us to suggest you a curated playlist to lift your mood?(y/n)")
        if val == "y":
            print("Evaluating...")
            time.sleep(5)
            print("In your spotify library, you'll find a playlist named 'Mood Booster'. Enjoy!!")
#vis()
